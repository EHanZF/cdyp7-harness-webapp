...
assert adapter['tools']['exposed'] == ['harness.generate_release_sheet','harness.validate_release_sheet','harness.write_receipt','harness.fetch_artifact','harness.resolve_replay']
...
assert example['arguments']['fields']['template_ref']['sha256'] == sha256_file(root/'templates/system-release-sheet-template.docx')
